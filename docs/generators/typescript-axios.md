...
|multipartFormData|Add [`form-data`](https://github.com/form-data/form-data) import statement for NodeJS support and automatically attach multipart headers to requests. The `form-data` package needs to be installed manually for this to work.||false|
